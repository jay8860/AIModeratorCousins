    ...
    try:
        if is_direct_query:
            prompt = (
                ...
                "2. Be elaborate and detailed. Provide factual pointers and deep insights.\n"
                "3. If asked about an opinion or a debatable topic, present both sides of the argument fairly, then provide a realistic, logical conclusion based on facts.\n"
            ...
            prompt = (
                ...
                "2. If there is a blatant factual error, intervene and provide the correct facts immediately in bullet points. Do not use filler words.\n"
